...
Only numeric item stats exposed through Blizzard's item API are included. Weapon damage, speed, use effects, procs, unusual equip effects, set effects, buffs, and talent effects are not evaluated. Blizzard's original tooltips remain visible.

## Status

Version 0.1.0 targets the WoW Forever beta client with interface version `16001`. In-game validation is pending. Do not distribute this version as a CurseForge release yet.
